...
public class aAnalysis extends AppCompatActivity {
    @Override
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                ...
                switch(menuItem.getItemId()) {
                    case R.id.ic_new_plan:
                        Intent intent_newPlan = new Intent(aAnalysis.this, aPlan.class);
                        startActivity(intent_newPlan);
                        break;
                    case R.id.ic_workout:
                        Intent intent_workout = new Intent(aAnalysis.this, aWorkout.class);
